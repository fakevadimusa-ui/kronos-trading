...
def place_order(client: TradingClient, signal: dict, shares: int, equity: float = 0.0) -> None:
    """
...
def main() -> None:
    ...
    # count_ict_losses_today() reads the write-once append log — immune to
    # equity-recovery flickering from Kronos NVDA or any other concurrent bot.
    daily_losses = count_ict_losses_today()
    ...
    try:
        place_order(client, signal, shares, equity)
    except Exception as e:
